...
export const servicios: Servicio[] = [
  ...
  // =====================================================
  {
    ...
    faq: [
      ...
      { q: '¿Cubren todas las comunas de Santiago?', a: 'Sí, cubrimos toda la Región Metropolitana. El precio del traslado varía según la comuna. Para comunas lejanas (Talagante, Melipilla, extremos de Puente Alto) puede aplicar un recargo que te informamos antes de confirmar.' },
